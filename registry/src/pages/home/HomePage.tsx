...
import type { HomeLoaderResult } from "./homeLoader"; // so ts understands data being pulled out of useLoaderData hook

export default function HomePage() {
  const { featuredPackages } = useLoaderData() as HomeLoaderResult;
  // p is one single package
...
// we will make a query function called getFeaturedPackages(), make 4 requests in parrallel, and then return the results we get back into a PackageDetails array
// need to get access to data coming from our homeLoader. we will use hook useLoaderData
