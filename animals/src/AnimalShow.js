...
const svgMap = { // object where key is identical to value 
...
function AnimalShow({type}){ // prop of type that is a lowercase string telling us the name of the animal we want to render
